...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-02-2020 a las 18:03:05
...
CREATE TABLE `categoria_producto` (
  ...
  `CATPRO_descripcion` varchar(100) CHARACTER SET utf32 COLLATE utf32_spanish2_ci NOT NULL
...
--
-- Estructura de tabla para la tabla `origen_proveedor`
--

CREATE TABLE `origen_proveedor` (
  `ORIPROVE_id` int(11) NOT NULL,
  `ORIPROVE_descripcion` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `origen_proveedor`
--

INSERT INTO `origen_proveedor` (`ORIPROVE_id`, `ORIPROVE_descripcion`) VALUES
(1, 'Nacional'),
(2, 'Extranjero');
...
CREATE TABLE `producto` (
  ...
  `PRO_modelo` varchar(100) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `PRO_detalle` mediumtext NOT NULL,
...
CREATE TABLE `proveedor` (
  `PROVE_id` int(20) NOT NULL,
  `PROVE_ruc` char(11) DEFAULT NULL,
  `PROVE_razon_social` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `PROVE_razon_comercial` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `PROVE_direccion` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `PROVE_email` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `PROVE_telefono` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `PROVE_etiqueta` text DEFAULT NULL,
  `PROVE_dni` varchar(8) DEFAULT NULL,
  `PROVE_estado` int(10) DEFAULT NULL,
  `PROVE_dias_credito` int(3) DEFAULT NULL,
  `PROVE_origen` varchar(100) DEFAULT NULL,
  `PROVE_web` varchar(200) DEFAULT NULL,
  `PROVE_region` varchar(70) DEFAULT NULL,
  `PROVE_pais` varchar(70) DEFAULT NULL,
  `PROVEDOC_id` int(11) NOT NULL,
  `TIPPROVE_id` int(11) NOT NULL,
...
CREATE TABLE `proveedor_contacto` (
  `PROVECONT_id` int(10) NOT NULL,
  `PROVECONT_descripcion` varchar(300) NOT NULL,
  `PROVECONT_nombre` varchar(200) NOT NULL,
  `PROVECONT_telefono` varchar(200) NOT NULL,
  `PROVECONT_email` varchar(200) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `PROVE_id` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `proveedor_cuenta` (
  `PROVECU_id` int(10) NOT NULL,
  `PROVECU_beneficiario` varchar(200) NOT NULL,
  `PROVECU_cuenta` varchar(200) NOT NULL,
  `PROVECU_observacion` text DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `PROVE_id` int(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `proveedor_documento` (
  `PROVEDOC_id` int(11) NOT NULL,
  `PROVEDOC_descripcion` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `proveedor_documento`
--

INSERT INTO `proveedor_documento` (`PROVEDOC_id`, `PROVEDOC_descripcion`) VALUES
(1, 'DNI'),
...
--
-- Estructura de tabla para la tabla `proveedor_exped`
--

CREATE TABLE `proveedor_exped` (
  `PROEXP_id` int(20) NOT NULL,
  `PROEXP_descripcion` varchar(300) DEFAULT NULL,
  `PROEXP_ruta` varchar(300) DEFAULT NULL,
  `PROEXP_extension` varchar(20) DEFAULT NULL,
  `PROVE_id` int(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `proveedor_exped`
--

INSERT INTO `proveedor_exped` (`PROEXP_id`, `PROEXP_descripcion`, `PROEXP_ruta`, `PROEXP_extension`, `PROVE_id`, `USER_id`, `created_at`, `updated_at`) VALUES
(8, 'Expediente de Molina', '1580313673_prueba.jpg', 'jpg', 1, 1, '2020-01-29 16:01:13', NULL),
(9, 'Expediente de Molina', '1580314215_MODELAMIENTO DEL PROCESO GESTION DE IMPORTACIONES.bpm', 'bpm', 1, 1, '2020-01-29 16:10:15', NULL);
...
CREATE TABLE `tipo_proveedor` (
  `TIPPROVE_id` int(11) NOT NULL,
  `TIPPROVE_descripcion` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tipo_proveedor` (`TIPPROVE_id`, `TIPPROVE_descripcion`) VALUES
(1, 'Empresa'),
(2, 'Persona natural');
...
--
-- Indices de la tabla `origen_proveedor`
--
ALTER TABLE `origen_proveedor`
  ADD PRIMARY KEY (`ORIPROVE_id`);
...
ALTER TABLE `proveedor`
  ...
  ADD UNIQUE KEY `PROVE_ruc` (`PROVE_ruc`),
  ADD KEY `TIPPROVE_id` (`TIPPROVE_id`),
  ADD KEY `PROVEDOC_id` (`PROVEDOC_id`);

--
-- Indices de la tabla `proveedor_contacto`
--
ALTER TABLE `proveedor_contacto`
  ADD PRIMARY KEY (`PROVECONT_id`),
...
ALTER TABLE `proveedor_cuenta`
  ADD PRIMARY KEY (`PROVECU_id`),
  ADD KEY `PROVE_id` (`PROVE_id`);

--
-- Indices de la tabla `proveedor_documento`
--
ALTER TABLE `proveedor_documento`
  ADD PRIMARY KEY (`PROVEDOC_id`);

--
-- Indices de la tabla `proveedor_exped`
--
ALTER TABLE `proveedor_exped`
  ADD PRIMARY KEY (`PROEXP_id`),
  ADD KEY `PROVE_id` (`PROVE_id`);
...
--
-- AUTO_INCREMENT de la tabla `origen_proveedor`
--
ALTER TABLE `origen_proveedor`
  MODIFY `ORIPROVE_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `proveedor`
  MODIFY `PROVE_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `proveedor_contacto`
--
ALTER TABLE `proveedor_contacto`
  MODIFY `PROVECONT_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `proveedor_cuenta`
--
ALTER TABLE `proveedor_cuenta`
  MODIFY `PROVECU_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `proveedor_documento`
--
ALTER TABLE `proveedor_documento`
  MODIFY `PROVEDOC_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `proveedor_exped`
--
ALTER TABLE `proveedor_exped`
  MODIFY `PROEXP_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `tipo_proveedor`
--
ALTER TABLE `tipo_proveedor`
  MODIFY `TIPPROVE_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `proveedor_ibfk_1` FOREIGN KEY (`TIPPROVE_id`) REFERENCES `tipo_proveedor` (`TIPPROVE_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `proveedor_ibfk_2` FOREIGN KEY (`PROVEDOC_id`) REFERENCES `proveedor_documento` (`PROVEDOC_id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `proveedor_contacto`
--
ALTER TABLE `proveedor_contacto`
  ADD CONSTRAINT `proveedor_contacto_ibfk_1` FOREIGN KEY (`PROVE_id`) REFERENCES `proveedor` (`PROVE_id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `proveedor_cuenta`
--
ALTER TABLE `proveedor_cuenta`
  ADD CONSTRAINT `proveedor_cuenta_ibfk_1` FOREIGN KEY (`PROVE_id`) REFERENCES `proveedor` (`PROVE_id`) ON DELETE CASCADE;
COMMIT;
