...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">AdminLTE 3</span>   <h1>
          ...
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview" style="{{ ! Route::is('usuarios.index')?:'display:block'}}">
                    ...
                    <li class="nav-item ">
                      <a href="roles" class="nav-link {{ ! Route::is('roles.index')?:'active'}} ">
                        <i class="far fa-user nav-icon"></i>
                        <p>
                         Roles
            ...
            <!-- endif -->
          <li class="nav-item ">
            <a href="compras" class="nav-link {{ ! Route::is('compras')?:'active'}} ">
