        ...
        <ul class="metismenu" id="side-menu">
            ...
            <li >
                <a href="javascript: void(0); class="nav-link {{ ! Route::is('proveedorIndex')?:'active'}}"">
                    <i class="fe-map"></i>
                    <span>Logistica y Proveedores </span>
                ...
                <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <li >
                        <a href="{{route('productosIndex')}}" class="nav-link {{ ! Route::is('productosIndex')?:'active'}} ">Productos</a>
                        </li>

                        <li >
                            <a href="{{route('categoriaIndex')}}" class="nav-link {{ ! Route::is('categoriaIndex')?:'active'}} ">Categoria de Producto</a>
                            </li>
                            <li >
                                <a href="{{route('marcaIndex')}}" class="nav-link {{ ! Route::is('marcaIndex')?:'active'}} ">Marca de Producto</a>
                                </li>
                    <li >
