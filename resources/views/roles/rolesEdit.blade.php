                            ...
                            <div class="page-title-box">
                                ...
                                <div class="row icons-list-demo" style="color:#373f5f">
                                    <div class="col-sm-12 col-md-7 col-lg-4" style="font-size: 19px;font-weight: bold;padding-top: 5px; padding-left: 0px">
                                        <i class="mdi mdi-24px mdi-home-city" style=" margin-right: -6px;color:#373f5f"></i>PRIVILEGIOS: {{$rol->ROL_descripcion}}
                                    </div>
                                        ...
                                        <div class="card-box " style=" padding-top: 0px; margin-bottom: 0px;padding-bottom: 5px;">
                                            ...
                                            <div class="tab-content ">
                                                <div class="tab-pane show active" id="messages">
                                                      ...
                                                      <div class="col-md-12">
                                                            <form action=" {{route('rolUpdate',[$rol])}}" method="POST"      enctype="multipart/form-data" class="col-md-12">
                                                                {{ csrf_field()}}
                                                            ...
                                                            <table class="table table-bordered">
                                                                <thead>
                                                                    ...
                                                                    <th colspan="2"  style="vertical-align: middle;"> <input type="text" class="form-control form-control-sm"  name="ROL_descripcion"  id="PROVE_direccion" placeholder="Rol*" value="{{$rol->ROL_descripcion}}" required> </div> </th>
                                                                        ...
                                                                        @if ($menus->MENU_id==$submenus->MENU_id)
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                @if ($plantilla != null)
                                                                                    ...
                                                                                    @if ($plantilla->PLANTILLA_crear ==1)
                                                                                    <td>
                                                                                        <div class="custom-control custom-switch">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="custom-control custom-switch">
                                                                                        <input type="checkbox" class="custom-control-input SUBMENU-CREAR-{{$menus->MENU_id}}" id="SUBMENU-CREAR-{{$menus->MENU_id}}-{{$submenus->SUBMENU_id}}"  name="PLANTILLA_crear[]" value="{{$submenus->SUBMENU_descripcion}}">
                                                                                        <label class="custom-control-label" for="SUBMENU-CREAR-{{$menus->MENU_id}}-{{$submenus->SUBMENU_id}}" style="margin:0 50%;"></label>
                                                                                        </div>
                                                                                    </td>
                                                                                    @endif
                                                                                    @if ($plantilla->PLANTILLA_editar==1)
                                                                                    <td>
                                                                                        <div class="custom-control custom-switch">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="custom-control custom-switch">
                                                                                        <input type="checkbox" class="custom-control-input SUBMENU-EDITAR-{{$menus->MENU_id}}" id="SUBMENU-EDITAR-{{$menus->MENU_id}}-{{$submenus->SUBMENU_id}}"  name="PLANTILLA_editar[]" value="{{$submenus->SUBMENU_descripcion}}">
                                                                                        <label class="custom-control-label" for="SUBMENU-EDITAR-{{$menus->MENU_id}}-{{$submenus->SUBMENU_id}}" style="margin:0 50%;"></label>
                                                                                        </div>
                                                                                    </td>
                                                                                    @endif
                                                                                    @if ($plantilla->PLANTILLA_eliminar ==1)
                                                                                    <td>
                                                                                        <div class="custom-control custom-switch">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="custom-control custom-switch">
                                                                                        <input type="checkbox" class="custom-control-input SUBMENU-ELIMINAR-{{$menus->MENU_id}}" id="SUBMENU-ELIMINAR-{{$menus->MENU_id}}-{{$submenus->SUBMENU_id}}"  name="PLANTILLA_eliminar[]" value="{{$submenus->SUBMENU_descripcion}}">
                                                                                        <label class="custom-control-label" for="SUBMENU-ELIMINAR-{{$menus->MENU_id}}-{{$submenus->SUBMENU_id}}" style="margin:0 50%;""></label>
                                                                                        </div>
                                                                                    </td>
                                                                                    @endif
                                                            ...
                                                            <div class="modal-footer d-flex" style="background:#f5f5f5">
                                                                <a href="{{route('rolesIndex')}}"><button type="button" class="btn btn-primary" style="background-color: #af2323;border-color: #af2323;">Cancelar</button></a>
