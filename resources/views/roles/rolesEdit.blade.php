                                                                        ...
                                                                        @if ($menus->MENU_id==$submenus->MENU_id)
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                @if ($plantilla != null)
                                                                                    ...
                                                                                    @else
                                                                                        <td><div class="switchery-demo  text-center">  <input type="checkbox" data-plugin="switchery" data-color="#64b0f2" data-size="small" name="PLANTILLA_crear[]" value="{{$submenus->SUBMENU_descripcion}}"/> </div></td>
                                                                                    @endif
                                                                                    ...
                                                                                    @else
                                                                                        <td><div class="switchery-demo  text-center">  <input type="checkbox"  data-plugin="switchery" data-color="#64b0f2" data-size="small" name="PLANTILLA_editar[]" value="{{$submenus->SUBMENU_descripcion}}"/> </div></td>
                                                                                    @endif
                                                                                    ...
                                                                                    @else
                                                                                        <td><div class="switchery-demo  text-center">  <input type="checkbox"  data-plugin="switchery" data-color="#64b0f2" data-size="small" name="PLANTILLA_eliminar[]" value="{{$submenus->SUBMENU_descripcion}}"/> </div></td>
                                                                                    @endif
                                                                                @else
                                                                                <td ><div class="switchery-demo text-center">  <input type="checkbox"  data-plugin="switchery" data-color="#64b0f2" data-size="small" name="SUBMENU_id[]" value="{{$submenus->SUBMENU_descripcion}}"/> </div></td>
                                                                                <td><div class="switchery-demo  text-center">  <input type="checkbox"  data-plugin="switchery" data-color="#64b0f2" data-size="small" name="PLANTILLA_crear[]" value="{{$submenus->SUBMENU_descripcion}}"/> </div></td>
